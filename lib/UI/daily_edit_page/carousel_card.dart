...
import 'package:lifestyle_tracker/UI/daily_edit_page/carousel_list.dart';
...
class CarouselCard extends ConsumerStatefulWidget {
  const CarouselCard(this.parameter, this.index, {Key? key}) : super(key: key);
...
class _GenericEditPanelState extends ConsumerState<CarouselCard> {
...
class Label extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    int indexProvider = ref.watch(currentCardPageProvider);
      ...
      children: [
        ...
        showLabelPanel
            ...
            : IconButton(
                onPressed: () {
                  print("index: $index");
                  ref.read(currentCardPageProvider.notifier).state = index;
                  ref.read(showLabelPanelProvider.notifier).state =
                      !showLabelPanel;
                },
                icon: const Icon(
